...
*@自新增定义
******************************************************/
#define   Pout(addr,n)		*(unsigned int *)((addr & 0xf0000000)+0x02000000+((addr & 0x00ffffff)<<5)+(n<<2)) 
#define   Pint(addr,n)		*(unsigned int *)((addr & 0xf0000000)+0x02000000+((addr & 0x00ffffff)<<5)+(n<<2)) 
#define   GPIOB_ODR       (*(unsigned int *)0x40010c0c)
#define   LED_G_TOGGLE   {GPIOB_ODR  ^= (unsigned int)0x0001;}
#define   GPIOB_ODR_Addr 			0x40010c0c
#define   GPIOB_IDR_Addr			0x40010808
/**
